 ...
 * This class is thread-safe. All methods are static and do not modify any shared state.
 *
 * <p><b>Notes:</b> <br>
 * - This class cannot be instantiated. - Ensure SLF4J and a compatible logging implementation
 * (e.g., Logback) are included in the classpath.
 */
@Slf4j
public class NoraLogger {
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging informational messages helps in understanding the flow of the application and can be
   * useful for debugging and monitoring purposes. It provides insights into the application's
   * operations and can help identify issues when they arise.
   *
   * <p><b>Notes:</b> <br>
   * - This method uses varargs to allow multiple arguments to be passed, which will be formatted
   * into the message. - The {@code @NonNull} annotation indicates that the parameters should not be
   * null.
   *
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging exceptions or errors helps in identifying and diagnosing issues within the application.
   * It provides a way to capture and log the details of an exception, which can be useful for
   * troubleshooting and debugging.
   *
   * <p><b>Notes:</b> <br>
   * - This method is useful for logging exceptions or errors that occur during the application's
   * execution. - The {@code @NonNull} annotation indicates that the parameters should not be null.
   *
   * @param message the message to be logged; must not be null
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging warning messages helps in identifying potential issues or areas of concern within the
   * application. It provides a way to capture and log messages that may require attention or
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging warning messages with an associated throwable helps in identifying potential issues or
   * areas of concern within the application. It provides a way to capture and log messages that may
   * require attention or further investigation.
   *
   * <p><b>Notes:</b> <br>
   * - This method is useful for logging warnings or potential issues that may require further
   * investigation. - The {@code @NonNull} annotation indicates that the parameters should not be
   * null.
   *
   * @param message the message to be logged; must not be null
   * @param throwable the throwable associated with the message; must not be null
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging error messages helps in identifying and diagnosing issues within the application. It
   * provides a way to capture and log messages that indicate a problem or error condition.
   *
   * <p><b>Notes:</b> <br>
   * - This method uses varargs to allow multiple arguments to be passed, which will be formatted
   * into the message. - The {@code @NonNull} annotation indicates that the parameters should not be
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging error messages with an associated throwable helps in identifying and diagnosing issues
   * within the application. It provides a way to capture and log messages that indicate a problem
   * or error condition.
   *
   * <p><b>Notes:</b> <br>
   * - This method is useful for logging errors or exceptions that indicate a problem within the
   * application. - The {@code @NonNull} annotation indicates that the parameters should not be
   * null.
   *
   * @param message the message to be logged; must not be null
   * @param throwable the throwable associated with the message; must not be null
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging debug messages helps in understanding the internal workings of the application. It
   * provides detailed information that can be useful for debugging and troubleshooting purposes.
   *
   * <p><b>Notes:</b> <br>
   * - This method uses varargs to allow multiple arguments to be passed, which will be formatted
   * into the message. - The {@code @NonNull} annotation indicates that the parameters should not be
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging debug messages with an associated throwable helps in identifying and diagnosing issues
   * within the application. It provides a way to capture and log the details of an exception, which
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging trace messages helps in understanding the internal workings of the application. It
   * provides detailed information that can be useful for debugging and troubleshooting purposes.
   *
   * <p><b>Notes:</b> <br>
   * - This method uses varargs to allow multiple arguments to be passed, which will be formatted
   ...
   *
   * <p><b>Why:</b> <br>
   * Logging trace messages with an associated throwable helps in identifying and diagnosing issues
   * within the application. It provides a way to capture and log the details of an exception, which
   * can be useful for troubleshooting and debugging.
   *
   * <p><b>Notes:</b> <br>
