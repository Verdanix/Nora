...
public class TraceFileTest {
  ...
  public void testFile() {
    Constants.LOG_FILE_LOGGER.trace("HELLO TRACE");
    Assertions.assertTrue(Files.exists(Constants.logPath));
    Assertions.assertTrue(Files.readString(Constants.logPath).contains("HELLO TRACE"));
  }

  @Test
  @SneakyThrows
  public void testFilePlaceholder() {
    Constants.LOG_FILE_LOGGER.trace("{} {}", "HELLO", "PLACEHOLDER");
    Assertions.assertTrue(Files.exists(Constants.logPath));
